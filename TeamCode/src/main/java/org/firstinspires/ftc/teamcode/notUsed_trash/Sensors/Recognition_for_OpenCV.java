...
public class Recognition_for_OpenCV extends  LinearOpMode{
    ...
    private static final double rectHeight = 0.5 / 8;
    private static final double rectWidth = 0.5 / 8;
    private static final double rectHeight1 = 0.5 / 8;
    private static final double rectWidth1 = 0.5 / 8;
    ...
    private static final float offsetY = 0f / 8f;//changing this moves the three
