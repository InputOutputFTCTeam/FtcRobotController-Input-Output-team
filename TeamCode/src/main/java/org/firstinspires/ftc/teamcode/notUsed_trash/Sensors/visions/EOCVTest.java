...
public class EOCVTest extends LinearOpMode {
    ...
    private static final float rectHeight = 0.7f / 8f;

    private static final float rectWidth = 0.7f / 8f;
    private static final float rectHeight1 = 0.7f / 8f;
    private static final float rectWidth1 = 0.7f / 8f;
    ...
    private static final float[] leftPos = {5.5f / 8f + offsetX, 4f / 8f + offsetY};
    private static final float[] rightPos = {6.5f / 8f + offsetX, 4f / 8f + offsetY};
